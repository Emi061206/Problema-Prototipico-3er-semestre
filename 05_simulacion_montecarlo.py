...
precio_historico_higo = 31496
volatilidad_higo = 0.12
prima_sostenibilidad = 0.15
costo_operativo = 65000
volumen_t = 10
iteraciones = 5000
...
# Calcula la utilidad neta proyectada de cada iteración considerando volumen y costos.
utilidad_neta_simulada = (precios_ajustados * volumen_t) - costo_operativo
...
plt.title("Simulación de Monte Carlo (5,000 Iteraciones): Distribución de Probabilidad de Rentabilidad (Higo)", fontsize=14)
